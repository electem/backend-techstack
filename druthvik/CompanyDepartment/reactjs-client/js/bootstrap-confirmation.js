	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				...
				'<a class="btn btn-small" href="" target="" role="button"></a>' +
				'<a class="btn btn-small" data-dismiss="confirmation" role="button"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
		, btnOkClass:  'btn-primary'
		, btnCancelClass:  ''
		, btnOkLabel: '<i class="fa fa-check white"></i> Yes'
		, btnCancelLabel: '<i class="icon-remove-sign"></i> No'
		, singleton: false
		, popout: false
		, onConfirm: function(){fireJSFDelete()}
		, onCancel: function(){}
	})
