...
function drawLogCouponChart() {
	chartOptions.chart.type = document.getElementById('chartForm:_chartType1').value;
	chartOptions.title.text = document.getElementById('chartForm:_chartTitle1').value;
	chartOptions.series = $.parseJSON(document
			.getElementById('chartForm:_chartSeries1').value);
	chartOptions.yAxis.title.text = document.getElementById('chartForm:_chartYaxis1').value;
	
	/*if($("div[class*='selectedChartType']").html() === 'Column Chart'){
		chartOptions.plotOptions.pie.innerSize = 100;
	}else if($("div[class*='selectedChartType']").html() === 'Area Chart'){
		chartOptions.plotOptions.pie.innerSize = 0;
	}*/
	
	chartLog = new Highcharts.Chart(chartOptions);
	
	if(document.getElementById('chartForm:_chartType1').value === 'pie'){
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("path").remove();
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("text").remove();
	}
}
...
function drawChart() {
	...
	if (chartOptions.series != null && chartOptions.series.length > 0) {
	...
	if (document.getElementById('chartForm:_chartType2') != null) {
		drawChart2();
	}
	if (document.getElementById('chartForm:_chartType2') != null) {
		drawChart3();
	...
	$('#combinedGraphSelection').click(function() {
		if (this.checked) {
			drawChartAll();
			$("#chartDiv1").hide();
			$("#chartDiv2").hide();
			...
			/*
			 * if($('#chartDiv2').css('display') != 'none') {
			 * $("#chartDiv2").show(); }
			 * 
			 * if($('#chartDiv3').css('display') != 'none') {
			 * $("#chartDiv3").show(); }
			 */
			drawChart2();
			drawChart3();
...
function drawChart2() {
	chartOptions2.chart.type = document.getElementById('chartForm:_chartType2').value;
	...
	chartOptions2.yAxis.title.text = document.getElementById('chartForm:_chartYaxis1').value;
	
	/*if($("div[class*='selectedChartType']").html() === 'Column Chart'){
		chartOptions2.plotOptions.pie.innerSize = 100;
	}else if($("div[class*='selectedChartType']").html() === 'Area Chart'){
		chartOptions2.plotOptions.pie.innerSize = 0;
	}*/
	
	if (chartOptions2.series != null && chartOptions2.series.length > 0) {
	...
	if(document.getElementById('chartForm:_chartType2').value === 'pie'){
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("path").remove();
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("text").remove();
	}
...
function drawChart3() {
	chartOptions3.chart.type = document.getElementById('chartForm:_chartType3').value;
	...
	chartOptions3.yAxis.title.text = document.getElementById('chartForm:_chartYaxis1').value;
	
	/*if($("div[class*='selectedChartType']").html() === 'Column Chart'){
		chartOptions3.plotOptions.pie.innerSize = 100;
	}else if($("div[class*='selectedChartType']").html() === 'Area Chart'){
		chartOptions3.plotOptions.pie.innerSize = 0;
	}*/

	if (chartOptions3.series != null && chartOptions3.series.length > 0) {
	...
	if(document.getElementById('chartForm:_chartType3').value === 'pie'){
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("path").remove();
		$("g[class*='highcharts-data-labels highcharts-tracker']").find("text").remove();
	}
}
