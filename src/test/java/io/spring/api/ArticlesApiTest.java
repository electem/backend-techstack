...
public class ArticlesApiTest extends TestWithCurrentUser {
  ...
  public void should_create_article_success() throws Exception {
    ...
    String header = "Ever wonder?";
    String body = "You have to believe";
    List<String> tagList = asList("reactjs", "angularjs", "dragons","java");
    Map<String, Object> param = prepareParam(title, description, body, header, tagList);
    ...
    when(articleCommandService.createArticle(any(), any()))
        .thenReturn(new Article(title, description, body,header, tagList, user.getId()));
    ...
    given()
        ...
        .body("article.header",equalTo(header))
  ...
  public void should_get_error_message_with_wrong_parameter() throws Exception {
    ...
    Map<String, Object> param = prepareParam(title, description, body, header,asList(tagList));
  ...
  public void should_get_error_message_with_duplicated_title() {
    ...
    String description = "Ever wonder how?";
    String body = "You have to believe";
    String header = "You have to believe";
    String[] tagList = {"reactjs", "angularjs", "dragons"};
    Map<String, Object> param = prepareParam(title, description, body, header,asList(tagList));
  ...
  private HashMap<String, Object> prepareParam(
      final String title, final String description, final String body,final String header, final List<String> tagList) {
