...
public class ArticleTest {
  ...
  public void should_get_right_slug() {
    Article article = new Article("a new   title", "desc", "body","header",Arrays.asList("java"), "123");
    assertThat(article.getSlug(), is("a-new-title"));
  }

  @Test
  public void should_get_right_slug_with_number_in_title() {
    Article article = new Article("a new title 2", "desc","header", "body", Arrays.asList("java"), "123");
  ...
  public void should_handle_other_language() {
    Article article = new Article("中文：标题", "desc", "body","header",  Arrays.asList("java"), "123");
    assertThat(article.getSlug(), is("中文-标题"));
  }

  @Test
  public void should_handle_commas() {
    Article article = new Article("what?the.hell,w", "desc", "body","header",  Arrays.asList("java"), "123");
