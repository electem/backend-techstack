...
var _a = require("routing-controllers"), createExpressServer = _a.createExpressServer, useContainer = _a.useContainer, Action = _a.Action;
var logger = pino({
    name: "rackmanagement",
    level: "debug"
});
    ...
    authorizationChecker: function (action) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, action.request.headers["authorization"]];
                    case 1:
                        token = _a.sent();
                        try {
                            temp = token.split(" ")[1];
