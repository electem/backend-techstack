...
public class ArticleQueryServiceTest extends DbTestBase {
  ...
  public void setUp() {
    ...
    article =
        new Article(
            "test", "desc", "body","header", Arrays.asList("java", "spring"), user.getId(), new DateTime());
  ...
  public void should_query_article_by_author() {
    ...
    Article anotherArticle =
        new Article("new article", "desc", "body","header", Arrays.asList("test"), anotherUser.getId());
    articleRepository.save(anotherArticle);
  ...
  public void should_query_article_by_tag() {
    Article anotherArticle =
        new Article("new article", "desc", "body","header", Arrays.asList("test"), user.getId());
    articleRepository.save(anotherArticle);
